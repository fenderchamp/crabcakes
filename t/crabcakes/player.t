...
is( $player->is_ready,  0, 'player no joined' );
...
isa_ok( $player->get_crab_cake(0), 'CrabCakes::CrabCake',
    '0 crab_cake' );
is( $player->crab_cakes_count, 4, 'count 4' );

isa_ok( $player->get_crab_cake(1), 'CrabCakes::CrabCake',
    '1 crab_cake' );
is( $player->crab_cakes_count, 4, 'count 4' );

isa_ok( $player->get_crab_cake(2), 'CrabCakes::CrabCake',
    '2 crab_cake' );
is( $player->crab_cakes_count, 4, 'count 4' );

isa_ok( $player->get_crab_cake(3), 'CrabCakes::CrabCake',
    '3 crab_cake' );
is( $player->crab_cakes_count, 4, 'count 4' );
...
#dies_ok(sub {my $player = CrabCakes::Player->new(player_counter=>3)},'new player player_counter 3 out of range');
